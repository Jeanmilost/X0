...
//------------------------------------------------------------------------------
std::string E_ExceptionFormatter::Format_HTML(const std::string& type,
                                              const std::string& message,
                                              const std::string& file,
                                              const std::string& function,
                                              unsigned           line)
...
//------------------------------------------------------------------------------
std::string E_ExceptionFormatter::Format_HTML_Private(const std::string& type,
                                                      const std::string& message,
                                                      const std::string& file,
                                                      const std::string& function,
                                                      unsigned           line)
...
//------------------------------------------------------------------------------
std::string E_ExceptionFormatter::Message_HTML(const std::string& message,
                                               const std::string& function,
                                               unsigned           line)
{
    std::ostringstream sstr;
...
const char* E_Exception::Format() const
{
    ...
    sstr << "[E_Exception raised]" << std::endl << "[Message]  ";
...
//------------------------------------------------------------------------------
const char* E_Exception::Format_HTML() const
{
    std::ostringstream sstr;

    sstr << "[E_Exception raised]" << "<br>" << "[Message]  ";
...
//------------------------------------------------------------------------------
const char* E_Exception::Format_HTML_Private() const
{
    std::ostringstream sstr;
